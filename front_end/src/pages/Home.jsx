...
const Home = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div
        id="results-section"
        className={`transition-all duration-300 ${showResults ? "opacity-100" : "opacity-50"}`}
      >
        {showResults && (
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              ...
              (
                ...
                <>
                  <FeedbackPrompt
                    ...
                    onYes={handleOpenFeedbackFromPrompt}
                    onNo={handleDismissFeedbackPrompt}
                    onClose={handleDismissFeedbackPrompt}
                  />
                </>
              ) && (
                <>
        ...
        <div className="card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-blue-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-blue-700">
                Use a scale and measuring tape for weight and height. Measure in
                the morning for consistency.
              </p>
            </div>
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-green-700">
                Resting BPM is best measured in the morning before getting up.
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-purple-700">
                Use apps like MyFitnessPal to track calories and macros
                accurately for a few days before inputting.
              </p>
            </div>
          </div>
        </div>
